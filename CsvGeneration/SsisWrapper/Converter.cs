...
namespace DynamicCsvGeneration.SsisWrapper
{
    public static class Converter
    {
        ...
        public static SSISDataTypeWithProperty TranslateSqlServerDataTypeToSSISDataTypeWithProperty(string sqlServerDataType, string dataTypeLength, int codepage = 1252)
        {
            SSISDataType dt;
            ...
            else
            {
                switch (sqlServerDataType.ToLower())
                {
                    ...
                    case "smallint":
                        ...
                        break;
                    case "tinyint":
                        dt = SSISDataType.DT_I1;
                        break;
                    case "money":
                        dt = SSISDataType.DT_CY;
                        break;
                    case "datetime":
                    ...
                    case "numeric":
                        ...
                        break;
                    case "decimal":
                        dt = SSISDataType.DT_DECIMAL;
                        break;
                    case "varbinary":
                        dt = SSISDataType.DT_IMAGE;
                        break;
